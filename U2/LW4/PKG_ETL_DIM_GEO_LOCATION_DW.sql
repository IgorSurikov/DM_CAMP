create or replace PACKAGE BODY pkg_etl_dim_geo_location_dw AS

    PROCEDURE load_t_geo_location AS
    BEGIN
        DECLARE BEGIN
            EXECUTE IMMEDIATE 'truncate TABLE t_geo_location';
        ...
        END;
    END load_t_geo_location;

END pkg_etl_dim_geo_location_dw;